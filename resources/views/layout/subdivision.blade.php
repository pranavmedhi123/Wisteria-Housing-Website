...
<body>
    ...
    <div class="topnav" id="myTopnav">
        <a href="subdivisionhome.php" class="active">HOME</a>
        <!--<a href="subdivcontactus.html">CONTACT US</a>-->
        <a href="http://sxu8077.uta.cloud/" target="_blank">BLOG</a>
        <a href="subdivdashboard.php"  >DASHBOARD</a>
        <a href="Subdivision_resident_details.php">RESIDENT DETAILS</a>
        <a href="Subdivision_contact_create_reports.php? username=<?php echo $_SESSION['my_temp_Username'];?>">CREATE REPORTS</a>
        <a href="Subdivision_contact_superuser.php">CONTACT ADMIN</a>
