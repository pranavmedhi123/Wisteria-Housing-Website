...
<body>
    ...
    <div class="topnav" id="myTopnav">
        <a href="apartmenthome.php" class="active">HOME</a>
    <!--<a href="apartmentcontactus.html" >CONTACT US</a>-->
    <a href="http://sxu8077.uta.cloud/" target="_blank">BLOG</a>
    <a href="apartmentdashboard.php?username=<?php echo $_REQUEST["my_temp_Username"];?>">DASHBOARD</a>
    <a href="Apartment_owner_file_complaint.php?username=<?php echo $_REQUEST["my_temp_Username"];?>">FILE COMPLAINT</a>
